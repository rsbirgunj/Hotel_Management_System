...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">rsbirgunj@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9334750750</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">The hotel is located in a walking distance to all major embassies, airline offices, banks, immigration office and the famous shopping centers of Bangalore. It is only 8km from the Kempegowda International Airport Bangalore and has a panoramic view of the Bangalore and the surrounding hills.The hotel offers accommodation of international standard at reasonable rates with all the basic amenities essential for a deluxe hotel.</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lucas Jimenez</h4>
							<span>CEO</span>
							<p>For some, running a Hotel is a business. For us, it is our calling. Our passion for room and fine dining comes first, business second. We are a chef-driven restaurant. For you, that means fine dining at its best. We invite you to join us for an unforgettable culinary experience.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Emerging professional positioned to contribute superb communications, administrative, customer service, and organizational talents to excel as Hotel Front Desk Agent.</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>This place is the best. The pool, ocean, and town are all so accessible and the place is clean and comfortable. Would stay here again anytime!</p>
								<h5>Mirtunjay Chauhan</h5>
								<p>Nepal</p>
							</div>
							<div class="clearfix"> </div>
						</li>
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Great location close to the action and huge yummy breakfast every day! Liked the owner's ecological responsibility for their environment. Beautiful grounds and house - a pleasure to stay at.</p>
								<h5>Syed Farhan Hashmi</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
						</li>
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>We love the place, the swimming pool, the room. The house is just wonderful. The breakfast was great too.</p>
								<h5>Shardha Singh</h5>
								<p>Itlay</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Very clean, neat, fully equipped and well-furnished to world class standards!</p>
								<h5>Akshay Slathia</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
						</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9334750750</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">rsbirgunj@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Chokkanahalli, Chikkajala, Bangalore North,(Near Chikkajala Police station on NH7 /International Airport Road) Bangalore 562157</p>
